...
public class Zergling extends Unit implements IZerg {
	...
	@Override 
	public void attack(Object attackUnit, Object victimUnit) { //공격할때마다 상대방 체력을 2씩 떨어뜨린다.  공중유닛은 지상유닛을 공격할수있지만 지상유닛은 공중유닛을 공격할수없다.
	...
	public void run() { //빠르게 달린다.
		System.out.println("빠르게달린다.");
	}
}
